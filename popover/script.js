  ...
  switch (newpop.place) {
    case "top":
      popover.setAttribute(
        "style",
        `transform:translate3d(${btnPosX + btnPosW / 2 - popoverWidth / 2}px, ${btnPosY - popoverHeight - 10}px, 0px)`,
      );
      break;
    case "left":
      popover.setAttribute(
        "style",
        `transform:translate3d(${btnPosX - popoverWidth - 10}px, ${btnPosY - btnPosH / 2}px, 0px)`,
      );
      break;
    case "right":
      popover.setAttribute(
        "style",
        `transform:translate3d(${btnPosX + btnPosW + 10}px, ${btnPosY - btnPosH / 2}px, 0px)`,
      );
      break;
    case "bottom":
      popover.setAttribute(
        "style",
        `transform:translate3d(${btnPosX + btnPosW / 2 - popoverWidth / 2}px, ${btnPosY + btnPosH + 10}px, 0px)`,
      );
      break;
    default:
